...
public class CustomEditLastName extends CustomEditText {
	public CustomEditLastName(Context context) {
		super(context);
	}

	public CustomEditLastName(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public CustomEditLastName(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public void init() {

		View v = mInflater.inflate(R.layout.custom_edit_last_name, this, true);

		editText = (EditText) v.findViewById(R.id.edit_custom_last_name);
