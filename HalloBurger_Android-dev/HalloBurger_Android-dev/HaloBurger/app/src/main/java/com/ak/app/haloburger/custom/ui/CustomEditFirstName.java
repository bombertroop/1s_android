...
public class CustomEditFirstName extends CustomEditText {
	public CustomEditFirstName(Context context) {
		super(context);
	}

	public CustomEditFirstName(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public CustomEditFirstName(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public void init() {

		View v = mInflater.inflate(R.layout.custom_edit_first_name, this, true);

		editText = (EditText) v.findViewById(R.id.edit_custom_first_name);
